class WIPWorker
  ...
  def perform(edition_id)
    ...
    case `uname`.strip
    when 'Darwin' # OSX
      system "cd #{disk_path}; webkit2png -z 2.0 -C -s 1 --filename=wip --clipwidth=2880 --clipheight=1800 http://localhost:9494/editions/#{edition.id.to_s}/preview/main.html; mv wip-clipped.png wip.png"
